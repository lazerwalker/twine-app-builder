...
3. In your new repo, there will be a file in the `.github/workflows` subfolder called `main.yml`. On [line 22](https://github.com/lazerwalker/twine-app-builder/blob/main/.github/workflows/main.yml#L89), there are a few configuration variables for you to set around things like your game's name, description, and version number.
