...
1. Go through the process of [creating a certificate for package signing](https://docs.microsoft.com/windows/msix/package/create-certificate-package-signing?WT.mt_id=spatial-0000-emwalkerspatial-8466-emwalker&WT.mc_id=spatial-0000-emwalker).
